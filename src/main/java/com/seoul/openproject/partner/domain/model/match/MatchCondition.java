...
//
//        @Schema(name= "value" , example = "SEOCHO(서초 클러스터), GAEPO(개포 클러스터), OUT_OF_CLUSTER(클러스터 외부)\n"
...
//            description = "앞에 영어를 값으로 보내면 됨, 장소, 시간, 식사 방식, 메뉴 등이 문자열로 전달.")
//        @NotNull
//        private String value;
//
//        @Schema(name= "ConditionCategory" , example = "PLACE, TIME_OF_EATING, WAY_OF_EATING, TYPE_OF_STUDY", description = "value가 어떤 분류에 속하는지, value의 example 윗줄 부터 순서대로")
//        @NotNull
//        private ConditionCategory conditionCategory;
//    }
